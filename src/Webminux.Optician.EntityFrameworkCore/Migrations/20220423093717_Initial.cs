    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ActivityArts", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    NextStepType = table.Column<int>(type: "int", nullable: false),
                    NextStepDage = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EconomicSyncHistories", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProductGroupNumber = table.Column<int>(type: "int", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Domestic = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Recprice = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Category = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Location = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    GrossWeight = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Volume = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ProductDiscountGroup = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MinStock = table.Column<int>(type: "int", nullable: false),
                    MinOrder = table.Column<int>(type: "int", nullable: false),
                    RecCostPrice = table.Column<double>(type: "float", nullable: false),
                    TenantId = table.Column<int>(type: "int", nullable: false),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EntityFieldMappings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EntityFieldMappings_CustomFields_CustomFieldId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActivityArtId = table.Column<int>(type: "int", nullable: false),
                    ActivityTypeId = table.Column<int>(type: "int", nullable: false),
                    EmployeeId = table.Column<long>(type: "bigint", nullable: false),
                    CustomerId = table.Column<long>(type: "bigint", nullable: true),
                    GroupId = table.Column<int>(type: "int", nullable: true),
                    IsFollowUp = table.Column<bool>(type: "bit", nullable: false),
                    FollowUpByEmployeeId = table.Column<long>(type: "bigint", nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastModifierUserId = table.Column<long>(type: "bigint", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Activities_AbpUsers_CustomerId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Activities_AbpUsers_FollowUpByEmployeeId",
                        column: x => x.FollowUpByEmployeeId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Activities_ActivityArts_ActivityArtId",
                        column: x => x.ActivityArtId,
                        principalTable: "ActivityArts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Activities_ActivityTypes_FollowUpTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TenantId = table.Column<int>(type: "int", nullable: false),
                    CustomerNo = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    ...
                    TownCity = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    Country = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    TelephoneFax = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EconomicAgreementGrantToken = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    EconomicAppSecretToken = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    BillyAgreementGrantToken = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    BillyAppSecretToken = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    BillyAccessToken = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SyncApiId = table.Column<int>(type: "int", nullable: false),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastModifierUserId = table.Column<long>(type: "bigint", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Companies_AbpTenants_TenantId",
                        column: x => x.TenantId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ActivityTasks_AbpUsers_AssignedToId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TenantId = table.Column<int>(type: "int", nullable: false),
                    ODRightSPH = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    ODRightCYL = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    ODRightAXIS = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    ODRightVD = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    ODRightNEARADD = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    ODRightVN = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    OSLeftSPH = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    OSLeftCYL = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    OSLeftAXIS = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    OSLeftVD = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    OSLeftNEARADD = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    OSLeftVN = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    LensType = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    LensFor = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    LensSide = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EyeTools", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EyeTools_Activities_ActivityId",
                        column: x => x.ActivityId,
                        principalTable: "Activities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Invites_Activities_ActivityId",
                        column: x => x.ActivityId,
                        principalTable: "Activities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TenantId = table.Column<int>(type: "int", nullable: false),
                    InvoiceNo = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Activities_ActivityArtId",
                table: "Activities",
                column: "ActivityArtId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Activities_FollowUpByEmployeeId",
                table: "Activities",
                column: "FollowUpByEmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_Activities_FollowUpTypeId",
                table: "Activities",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ActivityTasks_AssignedToId",
                table: "ActivityTasks",
                column: "AssignedToId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EntityFieldMappings_CustomFieldId",
                table: "EntityFieldMappings",
                column: "CustomFieldId");

            migrationBuilder.CreateIndex(
                name: "IX_EyeTools_ActivityId",
                table: "EyeTools",
                column: "ActivityId");

            migrationBuilder.CreateIndex(
                name: "IX_Invites_ActivityId",
                table: "Invites",
                column: "ActivityId");
