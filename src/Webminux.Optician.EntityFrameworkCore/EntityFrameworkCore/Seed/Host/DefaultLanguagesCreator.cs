...
namespace Webminux.Optician.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = OpticianConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
            return new List<ApplicationLanguage>
            {
                ...
                new ApplicationLanguage(tenantId, "da", "Danish", "famfamfam-flags da"),
                new ApplicationLanguage(tenantId, "bg", "Bulgarian", "famfamfam-flags bg"),
            };
        }

        public DefaultLanguagesCreator(OpticianDbContext context)
        {
            _context = context;
        }
